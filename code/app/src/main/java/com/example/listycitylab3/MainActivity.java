...
public class MainActivity extends AppCompatActivity implements
    ...
    public void editCity(City city, String newName, String newProvince) {
        ...
        city.setProvinceName(newProvince);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Use the newInstance(City city) method with the city to edit
                AddCityFragment.newInstance(cityToEdit).show(getSupportFragmentManager(), "EDIT_CITY_DIALOG");
            }
        });
    }
}